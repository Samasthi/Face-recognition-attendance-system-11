    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name=r'C:\Users\Welcome\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance\Manually Attendance\ '+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\Welcome\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = r'C:\Users\Welcome\Downloads\Attendace_management_system-master\Attendace_management_system-master\ ' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\Welcome\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'kushal' :
            if password == 'kushal14320':
                ...
                cs = r'C:\Users\Welcome\Downloads\Attendace_management_system-master\Attendace_management_system-master\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
